...
colnames(DadosPhen)[c(10:41, 47:56)] <- c("Stand", "PRC", "PRNC", "PTR", "PPA", "DMCsg",
...
DadosParQuant <- DadosPhen[,c(1:30,33:40,51)]
DadosParQual <- DadosPhen[,c(1:9,31:32,52)]
...
DadosHCN <- DadosPhen[,c(1:9, 42:50)]

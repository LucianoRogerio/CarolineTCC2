...
colnames(DadosPhen)[c(8:26,32:49)] <- c("PRC", "PTR", "PPA", "IC", "AP",
                                        "NMa", "DMCsg", "DRY", "PA", "PRNC",
                                        "Vigor45D", "Vigor12M", "RF", "NR", "PPD",
                                        "PRCas", "PRPol", "FrogSkin", "CorPol", "Friab",
                                        "MoscBc", "MoscBr", "MurPA", "MosCm", "MosNv",
                                        "AcSev", "BacSev", "FerSev",
                                        paste0("HCN-",1:9))
head(DadosPhen)

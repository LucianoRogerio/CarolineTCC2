...
colnames(DadosPhen)[c(10:46, 52:62)] <- c("Stand", "PRC", "PRNC", "PTR", "PPA", "DMCsg",
                                         ...
                                         paste0("HCN-",1:9), "TCC", "StC")

DadosPhen <- DadosPhen %>%
  mutate(Cook = ifelse(Cook15 == 1,
                       yes = "15",
                       no = ifelse(Cook20 == 1,
                                   yes = "20",
                                   no = ifelse(Cook25,
...
DadosParQuant <- DadosPhen[,c(1:30,33:45,56:57)]
DadosParQual <- DadosPhen[,c(1:9,31:32,58)]
...
TC1Traits <- c("id", "IC", "PTR", "NRz", "DRY", "DMCsg", "StC", "PPA", "PA", "PRz")

...
TC2Traits <- c("Anth", "BlLS", "BrLS", "WhLS")
...
TC3Traits <- c("HCNPic", "DMCsg", "DeteorizaçãoFisiologica")
```
...
write.table(DataCarTCC2Pheno3, file= here::here("output", "TC1C", "DadosTC2Pheno3.csv"),
            quote = F, sep = ";", dec = ".")
```
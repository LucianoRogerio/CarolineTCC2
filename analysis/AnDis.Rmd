...
CC1AllData %>% rbind(CC1AllData %>% filter(id %in% CloneSelCC1, Method == "BAG") %>% 
  mutate(Method = "CC")) -> CC1AllData2
CC2AllData %>% rbind(CC2AllData %>% filter(id %in% CloneSelCC2, Method == "BAG") %>% 
  mutate(Method = "CC")) -> CC2AllData2
CC3AllData %>% rbind(CC3AllData %>%filter(id %in% CloneSelCC3, Method == "BAG") %>% 
